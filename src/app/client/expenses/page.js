...
export default function ExpensesPage() {
  ...
  async function addExpense(e) {
    ...
    if (!name.trim() || !category || !amount) {
      alert("Please fill out expense name, category, and amount.");
      return;
    }
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 text-[#5F6977]">
                  Track monthly bills, spending, and recurring expenses.
                </p>
              </div>

              <div className="rounded-3xl border border-[#E9DFD3] bg-white px-6 py-4 shadow-sm">
                <div className="text-sm text-[#5F6977]">Monthly Total</div>
