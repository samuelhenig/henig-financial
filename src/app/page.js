...
export default function Page() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "No. Some need help with debt, while others want more clarity around cash flow, tuition, and planning ahead.",
    },
    {
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-10 md:px-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-14 lg:py-16">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl font-semibold leading-[1.01] tracking-tight md:text-7xl">
              Feel back in control with a clear plan built around your family’s{" "}
              <span className="text-[#B57652]">real life.</span>
            </h1>

            <p className="mt-7 max-w-xl text-lg leading-8 text-[#5F6977] md:text-xl">
              We help families bring clarity, structure, and calm back into
              their finances through thoughtful, practical guidance.
            </p>

            <p className="mt-5 max-w-xl text-base leading-7 text-[#445060]">
              No shame. No generic system. Just a clearer way forward.
            </p>
              ...
              <div className="grid min-h-[620px] grid-rows-[1fr_auto]">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="rounded-[24px] bg-[rgba(251,248,243,0.94)] p-5 shadow-sm">
                        ...
                        <div className="mt-3 text-2xl font-semibold leading-tight text-[#1D2834]">
                          We work toward a clear plan built around your family’s
                          real life.
                        </div>
                      </div>
                      ...
                      <div className="rounded-[24px] bg-[#1F3448] p-5 text-white shadow-sm">
                        ...
                        <div className="mt-3 space-y-2 text-white/82">
                          ...
                          <div>• A stronger sense of control</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid gap-4 border-t border-white/30 bg-[rgba(255,255,255,0.28)] px-6 py-6 md:grid-cols-3 md:px-8">
                  {[
                    ...
                    [
                      "Clear plan",
                      "A practical path shaped around real life.",
                    ],
                    [
                      "Guidance that holds",
                      "Steady support you can actually live with.",
                    ],
                  ].map(([title, text]) => (
                    <div
                      key={title}
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-6 py-8 md:grid-cols-4 md:px-10 lg:px-14">
          {[
            ...
            [
              ...
              "The goal is steady progress your family can actually sustain.",
            ],
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <h2 className="text-4xl font-semibold leading-tight tracking-tight text-[#1D2834] md:text-5xl">
                A calmer, more personal way to work through family finances.
              </h2>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
              <div className="rounded-[34px] border border-[#E7DDD1] bg-white p-8 shadow-[0_16px_34px_rgba(29,40,52,0.05)] md:p-10">
                <p className="text-lg leading-8 text-[#5F6977]">
                  Before building any plan, we take the time to understand your
                  family’s reality — your income, obligations, habits, goals,
                  and pressure points — so the path forward feels honest,
                  practical, and possible.
                </p>

                <div className="mt-8 grid gap-4 md:grid-cols-2">
                  {[
                    "We work from your real numbers.",
              ...
              <div className="rounded-[34px] border border-[#E7DDD1] bg-[#1F3448] p-8 text-white shadow-[0_16px_34px_rgba(29,40,52,0.08)] md:p-10">
                ...
                <div className="space-y-5">
                  {[
                    [
                      "Before",
                      "Pressure, uncertainty, and month-to-month guessing.",
                    ],
                    [
                      "Middle",
                      "More clarity, better communication, and steadier decisions.",
                    ],
                    [
                      "After",
                      "A clearer plan, a calmer home, and a stronger sense of control.",
                    ],
                  ].map(([label, text]) => (
                    <div
                      key={label}
            ...
            <div className="grid xl:grid-cols-[1.18fr_0.82fr]">
              <div className="border-r border-[#ECE2D6] p-6 md:p-8 lg:p-10">
                ...
                <div className="mt-4 text-sm text-[#66707E]">
                  Not to compare — just to help you better understand where
                  things stand and begin to feel more in control.
                </div>
              </div>
              ...
              <div className="bg-[linear-gradient(180deg,#FCF8F3_0%,#F5EDE3_100%)] p-6 md:p-8 lg:p-10">
                <div className="rounded-[30px] border border-[#E7DACB] bg-white/75 p-6 shadow-sm">
                  ...
                  <p className="mt-4 leading-7 text-[#5F6977]">
                    ...
                    context. This section helps visitors understand where the
                    strain may be coming from and what a clearer plan may need
                    to address.
                  </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10 lg:px-14">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 text-lg leading-8 text-[#5F6977]">
                Practical tools to help you start getting clarity before we even
                speak.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {resources.length === 0 ? (
                <div className="md:col-span-2 rounded-[26px] border border-[#E6DBCF] bg-white p-8 text-center text-[#7B8794] shadow-[0_12px_28px_rgba(29,40,52,0.05)]">
      ...
      <section id="stories" className="bg-[#FBF8F3]">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10 lg:px-14">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {[
              {
                body: "For many families, this is the first time everything is clearly laid out — and things begin to feel more manageable.",
                label: "Young family with rising expenses",
                result: "More breathing room",
              },
              {
                body: "Instead of reacting month to month, there’s a clearer plan and a steadier sense of direction.",
                label: "Household trying to steady cash flow",
                result: "More clarity",
              },
              {
                body: "The numbers become easier to talk about, and the tension around money begins to ease at home.",
                label: "Couple carrying financial stress",
                result: "Less tension",
              },
            ].map((story) => (
              <div
              ...
              >
                ...
                <div className="mt-6 border-t border-[#EFE5D8] pt-4">
                  ...
                  <div className="text-sm text-[#7C8795]">{story.result}</div>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
                  ...
                  stand, what is creating pressure, and what kind of clear plan
                  may make the most sense from here.
                </p>
              </div>
